...
function AdminDashboard() {
	...
	// statusChangedHandler = statusChangedHandler.bind();
	...
	// FETCH DATA FROM API
	// fetch("https://backend.klivepay.com/api/admin/TotalCount")
	// 	.then((response) => response.json())
	// 	.then((res) => {
	// 		setState({
	// 			totalPaidWithdrawAmount: res.data.Total_paid_WithdrawAmount,
	// 			totalPendingWithdrawAmount: res.data.Total_pending_WithdrawAmount,
	// 			usersCount: res.data.users_count,
	// 			merchantCount: res.data.merchant_count,
	// 		});
	// 	});
